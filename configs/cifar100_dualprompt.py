...
def get_args_parser(subparsers):
    ...
    # my para
    subparsers.add_argument('--no_log',action='store_true',help = 'not gen log txt file')
    subparsers.add_argument('--no_checkpoints',action='store_true',help = 'not gen checkpoints pth file')
    subparsers.add_argument('--eval_all_tasks',action='store_true',help = 'each task stage eval all tasks')
